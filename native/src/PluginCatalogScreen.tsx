...
const styles = StyleSheet.create({
  ...
  search: { backgroundColor: palette.surface, borderColor: palette.line, borderRadius: 12, borderWidth: 1, color: palette.text, marginTop: 16, paddingHorizontal: 14, paddingVertical: 11 },
  ...
  section: { gap: 0 },
  sectionTitle: { color: palette.ink, fontSize: 15, fontWeight: "700", paddingBottom: 7, paddingHorizontal: 4 },
  empty: { color: palette.muted, paddingVertical: 10 },
  row: { alignItems: "center", flexDirection: "row", gap: 10, minHeight: 66, paddingHorizontal: 4, paddingVertical: 10 },
  ...
  officialMark: { height: 40, width: 40 },
  muted: { color: palette.muted, fontSize: 13 },
  status: { alignSelf: "flex-start", borderRadius: 999, fontSize: 12, fontWeight: "700", overflow: "hidden", paddingHorizontal: 9, paddingVertical: 5 },
  ...
  detailName: { color: palette.ink, fontSize: 22, fontWeight: "800", marginBottom: 4 },
