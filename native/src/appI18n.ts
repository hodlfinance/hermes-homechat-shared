...
const systemPagesFr: MobileSystemPagesCopy = {
  ...
  "automations": {
    ...
    "storedResultFailure": "Le dernier résultat est enregistré, mais la dernière exécution a aussi signalé un échec de livraison distinct.",
    "chat": "Discussion",
...
const systemPagesIt: MobileSystemPagesCopy = {
  ...
  "automations": {
    ...
    "storedResultFailure": "L’ultimo risultato è stato salvato, ma l’ultima esecuzione ha anche segnalato un errore di consegna separato.",
    "chat": "Chat",
  ...
  "tasks": {
    ...
    "notYetUpdated": "Non ancora aggiornato",
...
const systemPagesPt: MobileSystemPagesCopy = {
  ...
  "automations": {
    ...
    "storedResultFailure": "O último resultado foi salvo, mas a última execução também relatou uma falha de entrega separada.",
    "chat": "Chat",
  ...
  "tasks": {
    ...
    "notYetUpdated": "Ainda não atualizado",
...
const systemPagesJa: MobileSystemPagesCopy = {
  ...
  "automations": {
    ...
    "storedResultFailure": "最新の結果は保存されていますが、前回の実行では別の配信エラーも報告されました。",
    "chat": "チャット",
...
const systemPagesKo: MobileSystemPagesCopy = {
  ...
  "automations": {
    ...
    "storedResultFailure": "최신 결과는 저장되었지만 최근 실행에서 별도의 전달 오류도 보고되었습니다.",
    "chat": "채팅",
