...
const styles = StyleSheet.create({
  ...
  cardTitle: { color: palette.ink, flexShrink: 1, fontSize: 17, fontWeight: "800" },
  standardMark: { backgroundColor: palette.tealSoft, borderRadius: 999, paddingHorizontal: 9, paddingVertical: 3 },
  standardMarkText: { color: palette.muted, fontSize: 11, fontWeight: "800" },
  summary: { color: palette.text, fontSize: 14 },
  ...
  button: { backgroundColor: palette.accent, borderRadius: 999, paddingHorizontal: 12, paddingVertical: 8 },
  buttonText: { color: palette.accentText, fontSize: 11, fontWeight: "800" },
  ...
  versionsToggleText: { color: palette.muted, fontSize: 13, fontWeight: "700" },
